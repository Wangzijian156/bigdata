...
### 1.1、产生背景
 	...
 	随着数据量越来越大，在一个OS存不下所有的数据，那么就分配到更多的OS管理的磁盘中，需要一种系统来管理多台机器上的文件，这就是分布式文件管理系统。HDFS是分布式管理系统中的一种。
...
### 1.4、组成架构
 ...
 ![image-20200712221213208](https://gitee.com/wangzj6666666/blogImg-hadoop/blob/master/hadoop-hdfs/image-20200712221213208.png)
...
![image-20200712212718140](https://gitee.com/wangzj6666666/blogImg-hadoop/blob/master/hadoop-hdfs/image-20200712212718140.png)
...
![image-20200712213336527](https://gitee.com/wangzj6666666/blogImg-hadoop/blob/master/hadoop-hdfs/image-20200712213336527.png)
...
![image-20200712214150027](https://gitee.com/wangzj6666666/blogImg-hadoop/blob/master/hadoop-hdfs/image-20200712214150027.png)
...
![image-20200712213101011](https://gitee.com/wangzj6666666/blogImg-hadoop/blob/master/hadoop-hdfs/image-20200712213101011.png)
...
- 如果更新数据同时更新FsImage，就会导致效率过低，但如果不更新，就会发生一致性问题，一旦NameNode节点断电，就会产生数据丢失。因此，引入Edits文件；
- 如果长时间添加数据到Edits中，会导致该文件数据过大，效率降低，而且一旦断电，恢复元数据需要的时间过长。因此，需要定期进行FsImage和Edits的合并，如果这个操作   由NN节点完成，又会效率过低。因此，引入2NN。
```

![image-20200712223114416](https://gitee.com/wangzj6666666/blogImg-hadoop/blob/master/hadoop-hdfs/image-20200712223114416.png)
...
![image-20200712224322961](https://gitee.com/wangzj6666666/blogImg-hadoop/blob/master/hadoop-hdfs/image-20200712224322961.png)
...
![image-20200712225303668](https://gitee.com/wangzj6666666/blogImg-hadoop/blob/master/hadoop-hdfs/image-20200712225303668.png)
...
![image-20200712231014228](https://gitee.com/wangzj6666666/blogImg-hadoop/blob/master/hadoop-hdfs/image-20200712231014228.png)
