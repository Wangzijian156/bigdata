...
![image-20200810103109113](.\Flink开发（中）.assets\image-20200810103109113.png)
...
![image-20200810103924205](.\Flink开发（中）.assets\image-20200810103924205.png)
...
![image-20200810104341946](.\Flink开发（中）.assets\image-20200810104341946.png)
...
![image-20200810171831745](.\Flink开发（中）.assets\image-20200810171831745.png)
...
![image-20200810214511297](.\Flink开发（中）.assets\image-20200810214511297.png)

2）数据源（Source）将它们的状态写入检查点，并发出一个检查点 barrier

3）状态后端在状态存入检查点之后，会返回通知给 Source任务，Source 任务就会向 JobManager 确认检查点完成

![image-20200810214549310](.\Flink开发（中）.assets\image-20200810214549310.png)
...
![image-20200810214624749](.\Flink开发（中）.assets\image-20200810214624749.png)

7）当收到所有输入分区的 barrier 时，任务就将其状态保存到状态后端的检查点中，然后将 barrier 继续向下游转发

![image-20200810214747203](.\Flink开发（中）.assets\image-20200810214747203.png)

8）向下游转发检查点 barrier 后，任务继续正常的数据处理

![image-20200810214801517](.\Flink开发（中）.assets\image-20200810214801517.png)

9）Sink 任务向 JobManager 确认状态保存到 checkpoint 完毕

10）当所有任务都确认已成功将状态保存到检查点时，检查点就真正完成了

![image-20200810214818933](.\Flink开发（中）.assets\image-20200810214818933.png)
...
![image-20200811103607912](.\Flink开发（中）.assets\image-20200811103607912.png)
...
![image-20200810154855580](.\Flink开发（中）.assets\image-20200810154855580.png)

- 如果用滚动窗口，同样会出现应该报警却未报警的现象

![image-20200810155335550](.\Flink开发（中）.assets\image-20200810155335550.png)
